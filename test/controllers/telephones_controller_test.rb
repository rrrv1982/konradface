...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { id_telephone: @telephone.id_telephone, number: @telephone.number } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { id_telephone: @telephone.id_telephone, number: @telephone.number } }
